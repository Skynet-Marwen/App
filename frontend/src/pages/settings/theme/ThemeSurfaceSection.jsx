  ...
  return (
    <div className="space-y-4 rounded-xl border border-cyan-500/10 p-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
        ...
        <Select label="Sidebar Width" value={layout.sidebar_width || 'standard'} onChange={(event) => onLayoutChange('sidebar_width', event.target.value)} options={[{ value: 'narrow', label: 'Narrow' }, { value: 'standard', label: 'Standard' }, { value: 'wide', label: 'Wide' }]} />
        ...
        <Select label="Shell Mode" value={layout.shell_mode || 'fixed'} onChange={(event) => onLayoutChange('shell_mode', event.target.value)} options={[{ value: 'fixed', label: 'Fixed Shell' }, { value: 'document', label: 'Page Scroll' }]} />
        <Select label="Content Width" value={layout.content_width || 'regular'} onChange={(event) => onLayoutChange('content_width', event.target.value)} options={[{ value: 'narrow', label: 'Narrow' }, { value: 'regular', label: 'Regular' }, { value: 'wide', label: 'Wide' }, { value: 'full', label: 'Full Bleed' }]} />
        ...
        <Select label="Topbar" value={layout.topbar || 'default'} onChange={(event) => onLayoutChange('topbar', event.target.value)} options={[{ value: 'compact', label: 'Compact' }, { value: 'default', label: 'Default' }, { value: 'prominent', label: 'Prominent' }]} />
        <Select label="Sticky Header" value={layout.header_sticky === false ? 'off' : 'on'} onChange={(event) => onLayoutChange('header_sticky', event.target.value === 'on')} options={[{ value: 'on', label: 'Sticky' }, { value: 'off', label: 'Static' }]} />
