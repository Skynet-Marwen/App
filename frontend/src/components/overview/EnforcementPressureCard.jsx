...
export default function EnforcementPressureCard({ pressure, loading, className = '' }) {
      ...
      <div className="space-y-3">
        ...
        <div className="space-y-2.5">
          {LANES.map((lane) => {
            ...
            return (
            <div key={lane.key} className={`rounded-lg border ${lane.border} bg-black/30 px-3 py-2`}>
