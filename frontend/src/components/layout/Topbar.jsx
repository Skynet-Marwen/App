...
export default function Topbar({ title, showRange = false, onRefresh }) {
  ...
  const isCentered = typeof document !== 'undefined' && document.documentElement.dataset.themeHeaderAlignment === 'center'

  return (
    <header className="flex-shrink-0 border-b backdrop-blur-md z-20"
      style={{ background: 'var(--theme-header-bg)', borderColor: 'var(--theme-header-border)' }}>
      <div className="mx-auto flex min-h-16 w-full max-w-[1720px] items-center px-4 py-3 sm:px-5 lg:px-6 xl:px-8">
